...
public:
    ...
    virtual void CreateNodeView(const int32 nodeId, const FYNNodeContext& nodeContext) = 0;
    virtual void CreatePieceView(const int32 teamId, const int32 pieceId, const FYNPieceContext& pieceContext) = 0;
